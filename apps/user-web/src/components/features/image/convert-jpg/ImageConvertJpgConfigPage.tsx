...
import { ImageConvertJpgConfig } from './ImageConvertJpgConfig';
import { ConvertJpgConfig } from './ImageConvertJpgConfig';

export function ImageConvertJpgConfigPage({
  config,
  onChange,
  selectedFile,
  onRemoveFile,
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-900 text-center">
        {conversionType === 'to' ? 'Convert To JPG' : 'Convert From JPG'}
      </h2>
      <p className="text-gray-600 text-sm text-center mt-2">
        {conversionType === 'to'
          ? 'Convert your image to JPG format'
          : 'Convert your JPG image to various formats including png, svg and more.'}
      </p>
