...
import { ImageQualityConfig } from './ImageQualityConfig';
import { QualityConfig } from './ImageQualityConfig';

export function ImageQualityConfigPage({
  config,
  onChange,
  selectedFile,
  onRemoveFile,
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-900 text-center">Adjust Image Quality</h2>
      <p className="text-gray-600 text-sm text-center">
        Fine-tune the quality level of your image
      </p>
      <div className="grid grid-cols-2 gap-6 mt-6">
        {/* Left Section: Image Preview */}
        <div className="p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Image ready to process</h3>
          <ImagePreview
            file={selectedFile}
            onRemove={undefined}
            isUploading={false}
        ...
        {/* Right Section: Quality Configuration */}
        <div className="p-6">
          {error && (
