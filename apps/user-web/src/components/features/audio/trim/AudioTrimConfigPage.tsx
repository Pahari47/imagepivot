...
import { AudioTrimConfig } from './AudioTrimConfig';
import { TrimConfig } from './AudioTrimConfig';

export function AudioTrimConfigPage({
  config,
  onChange,
  selectedFile,
  onRemoveFile,
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-900 text-center">Trim your audio</h2>
      <p className="text-gray-600 text-sm text-center">
        Select the start and end time to extract a portion of your audio file
      </p>
      <div className="grid grid-cols-2 gap-6 mt-6">
        ...
        {/* Right Section: Trim Configuration */}
        <div className="p-6">
          {error && (
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0011 10v4a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
