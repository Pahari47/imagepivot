...
import { AudioMetadataConfig } from './AudioMetadataConfig';
import { MetadataConfig } from './AudioMetadataConfig';

export function AudioMetadataConfigPage({
  config,
  onChange,
  selectedFile,
  onRemoveFile,
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-900 text-center">Edit audio metadata</h2>
      <p className="text-gray-600 text-sm text-center">
        Add or edit ID3 tags and cover art for your audio file
      </p>
      <div className="grid grid-cols-2 gap-6 mt-6">
        ...
        {/* Right Section: Metadata Configuration */}
        <div className="p-6">
          {error && (
