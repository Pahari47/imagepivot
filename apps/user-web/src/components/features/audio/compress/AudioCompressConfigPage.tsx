...
import { AudioCompressConfig } from './AudioCompressConfig';
import { CompressConfig } from './AudioCompressConfig';

export function AudioCompressConfigPage({
  config,
  onChange,
  selectedFile,
  onRemoveFile,
  ...
  return (
    <div>
      <h2 className="text-2xl font-semibold text-gray-900 text-center">Compress your audio</h2>
